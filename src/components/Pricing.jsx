...
//       if (!res.ok) {
//         console.log("Country Status:", res.status);
...
//       } else {
//         console.error("Invalid country format:", data);
//         setCountryList([]);
//       }
//     } catch (err) {
...
//       console.log("Sending Rate Payload:", payload);
      ...
      <div className="max-w-lg mx-auto bg-white p-6 sm:p-8 rounded-2xl shadow-lg border border-red-200 w-full">
        ...
        {price !== null && (
          <div className="mt-6 p-4 bg-red-100 border border-red-300 rounded-lg">
            ...
            <span
              onClick={handleClick}
              className="ml-0 px-3 py-1 bg-red-500 text-white text-sm rounded cursor-pointer hover:bg-red-500 transition"
            >
              Send Your Order
            </span>
          </div>
